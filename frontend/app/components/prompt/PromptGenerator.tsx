...
const GUIDE_STEPS = [
    {
        num: "01", title: "Tipo de artículo",
        desc: "Selecciona en el panel lateral el tipo de investigación que vas a redactar.",
        detail: "Teórica · Sistemática · Empírica · Estudio de caso",
        color: "#003087",
    },
    {
        num: "02", title: "Datos del autor",
        desc: "Ingresa tu nombre, facultad, nivel académico y el nombre de tu asesor.",
        detail: "Nombre · Rol · Facultad · Nivel · Docente",
        color: "#C8102E",
    },
    {
        num: "03", title: "Contenido del artículo",
        desc: "Define el tema, objetivo e hipótesis. Cada tipo tiene campos específicos.",
        detail: "Tema · Objetivo · Hipótesis · Keywords",
        color: "#C9A84C",
    },
    {
        num: "04", title: "Formato y estilo",
        desc: "Configura la extensión, norma de citación, idioma y revista objetivo.",
        detail: "APA · Vancouver · Scopus · Español · Inglés",
        color: "#27ae60",
    },
    {
        num: "05", title: "Secciones del documento",
        desc: "Elige qué secciones incluirá tu artículo. Si no seleccionas, se usan todas.",
        detail: "Resumen · Introducción · Metodología · Conclusiones",
        color: "#8e44ad",
    },
    {
        num: "06", title: "Genera y copia",
        desc: "Presiona ⚡ Generar y obtendrás prompts listos. Expande y copia con un clic.",
        detail: "ChatGPT · Claude · Gemini · Copilot",
        color: "#2980b9",
    },
];
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                        <div>
                            <div style={{
                                ...
                                padding: "2px 10px", borderRadius: 20, marginBottom: 7,
                ...
                <div style={{ overflowY: "auto", flex: 1 }}>
                    ...
                    <div style={{
                        ...
                        {GUIDE_STEPS.map((step, i) => (
                            <div key={i} style={{
                                ...
                                onMouseEnter={e => {
                                    (e.currentTarget as HTMLElement).style.boxShadow = `0 6px 20px ${step.color}20`;
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 9 }}>
                                    <div style={{
                                        ...
                                        display: "flex", alignItems: "center", justifyContent: "center",
                                        fontSize: 10, fontWeight: 900, color: step.color,
                                        fontFamily: "Georgia, serif",
                                    }}>
                                        {step.num}
                                    </div>
                                    <div style={{
                                        flex: 1, height: 1.5, borderRadius: 2,
                                ...
                                {/* Título */}
                                <h3 style={{
                                    margin: "0 0 5px", fontSize: 12.5, fontWeight: 800,
                                    color: "#1a202c", letterSpacing: -0.2,
                                }}>
                                    {step.title}
                                </h3>
                                ...
                                {/* Descripción */}
                                <p style={{
                                    margin: "0 0 9px", fontSize: 11,
                                    color: "#718096", lineHeight: 1.6,
                                }}>
                                    {step.desc}
                                </p>
                    ...
                    <div style={{ padding: "0 24px 22px" }}>
                        <button onClick={onClose} style={{
                            ...
                            letterSpacing: 0.3, transition: "opacity 0.2s, transform 0.2s",
