...
// ─── Bloque de links al pie de cada prompt ────────────────────────────────────
    ...
    return (
        <div style={{
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8, alignItems: "center" }}>
                ...
                <a
                    ...
                    style={{
                        ...
                        padding: "8px 14px",
                        borderRadius: 9,
                        background: hovered === "scite.ai"
                            ? "#002070"
                            : "linear-gradient(135deg, #003087, #004ab5)",
                        border: "1.5px solid #C9A84C",
                        color: "#fff",
                        fontSize: 12, fontWeight: 800,
                        textDecoration: "none",
                        transition: "all 0.18s",
                        boxShadow: hovered === "scite.ai"
                            ? "0 6px 20px rgba(0,48,135,0.45)"
                            : "0 3px 10px rgba(0,48,135,0.3)",
                ...
                {/* Separador */}
                <div style={{
                    width: 1, height: 26, background: "#e2e8f0", margin: "0 2px",
                }} />
            ...
            <div style={{
                ...
                background: "linear-gradient(135deg, rgba(0,48,135,0.04), rgba(201,168,76,0.06))",
                border: "1px solid rgba(0,48,135,0.1)",
                fontSize: 10.5, color: "#4a5568", lineHeight: 1.6,
            }}>
...
export default function PromptOutput({
    prompts, tipoActivo, facultad, onEditarFormulario, onNuevoPrompt,
}: PromptOutputProps) {
    ...
    return (
        <div style={{ padding: "28px 32px 48px", maxWidth: 860, margin: "0 auto" }}>
            ...
            <div style={{
                ...
                <div>
                    <h2 style={{
                        margin: 0, fontSize: 18, color: COLORES.grisOscuro,
                ...
                <div style={{ display: "flex", gap: 10 }}>
                    <button
                        onClick={onEditarFormulario}
                        style={{
                            padding: "9px 18px", borderRadius: 8,
                            border: `1.5px solid ${COLORES.azul}`, background: "#fff",
                            color: COLORES.azul, fontSize: 13, fontWeight: 600,
                    ...
                    <button
                        onClick={onNuevoPrompt}
                        style={{
                            padding: "9px 18px", borderRadius: 8,
                            border: "none", background: COLORES.rojo,
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                ...
                                <span style={{ fontSize: 18, color: "#a0aec0", flexShrink: 0 }}>
                                    {abierto ? "▲" : "▼"}
                                </span>
                            </button>
                            ...
                            {abierto && (
                                <div style={{ padding: "0 20px 20px" }}>
                                    <pre style={{
                                        ...
                                        lineHeight: 1.7, color: "#2d3748", margin: "0 0 14px",
                                        fontFamily: "'Georgia', serif", maxHeight: 320,
                                        overflowY: "auto",
                                    }}>
                                        {p.texto}
                                    </pre>
